...
require (
	...
	github.com/aws/aws-sdk-go-v2/config v1.31.16 // direct
	github.com/aws/aws-sdk-go-v2/credentials v1.18.20 // direct
	...
	github.com/aws/aws-sdk-go-v2/service/s3 v1.89.1 // direct
